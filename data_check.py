...
dataset = GDIVardial2019Dataset(Path('swiss-german-text-encoders/data/gdi-vardial-2019/train.txt'),
                                 Path('swiss-german-text-encoders/data/gdi-vardial-2019/dev.txt'),
                                 Path('swiss-german-text-encoders/data/gdi-vardial-2019/gold.txt'))

dataset_synthetic = GDIVardial2019Dataset(Path('synthetic_data/complete_fewshot/combined_fewshot.txt'),
                                          Path('swiss-german-text-encoders/data/gemma-3-synthetic/dev.txt'),
                                          Path('swiss-german-text-encoders/data/gemma-3-synthetic/gold.txt'))
#dataset.print_statistics()
dataset_synthetic.print_statistics()
